% IEA 15 MW monopile + perfect wind preview + SI. 
...
% PFC providing synthetic inertia. 
% Here, only the rotor motion and tower motion (GenDOF and TwFADOF1) 
% are enabled. 
% Result: Cost ("30 s sprint"):  0.949424
...
%% Plot 
figure('Name','Simulation results FB vs. FBFF + SI')
...
ylabel({'GenTq'; '[MNm]'});
legend('feedback only','feedback-feedforward + synthetic inertia','Location','best')
