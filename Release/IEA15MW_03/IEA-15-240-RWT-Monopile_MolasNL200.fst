------- OpenFAST INPUT FILE -------------------------------------------
LAC Test IEA15MW_03: IEA 15 MW offshore reference model monopile configuration with realistic wind preview from a 4-beam pulsed lidar system
---------------------- SIMULATION CONTROL --------------------------------------
...
"IEA-15-240-RWT-Monopile_ServoDyn_MolasNL200.dat"   ServoFile   - Name of file containing control and electrical-drive input parameters (quoted string)
...
"MolasNL200_160m_LidarFile.dat"	SWELidarFile	- Name of file containing SWE Lidar input parameters (quoted string)
---------------------- OUTPUT --------------------------------------------------
