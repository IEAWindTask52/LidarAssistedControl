...
fprintf('Energy increase: %4.2f %%\n',(ProcessResults_LAC_CircularCW.LTW_mean_GenPwr_PerBin/ProcessResults_FeedbackOnly.LTW_mean_GenPwr_PerBin-1)*100)
fprintf('-------------------------------------------------\n')
...
fprintf('Energy increase: %4.2f %%\n',(ProcessResults_LAC_4BeamPulsed.LTW_mean_GenPwr_PerBin/ProcessResults_FeedbackOnly.LTW_mean_GenPwr_PerBin-1)*100)
fprintf('-------------------------------------------------\n')