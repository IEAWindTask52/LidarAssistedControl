...
! DS: Few changes to be used for compiling the FFP DLLs: 1) replace Rosco_Types with FFP_Types, 2) replace ErrorVariables with LidarErrorVariables, 3) add DbKi, IntKi, NewLine, PathSep
MODULE FFP_Helpers

    USE, INTRINSIC :: ISO_C_Binding
    USE FFP_Types 	! DS: ROSCO_Types renamed into FFP_Types
