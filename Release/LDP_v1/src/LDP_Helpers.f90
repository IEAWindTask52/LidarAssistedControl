...
! DS: Few changes to be used for compiling the LDP DLLs: 1) replace Rosco_Types with LDP_Types, 2) replace ErrorVariables with LidarErrorVariables, 3) add DbKi, IntKi, NewLine, PathSep
MODULE LDP_Helpers

    USE, INTRINSIC :: ISO_C_Binding
    USE LDP_Types 	! DS: ROSCO_Types renamed into LDP_Types
